...
public class Hospital {
    public static void main(String[] args) {
        ...
        d2.consultationFee(); // Calls Dentist overridden method
        d3.consultationFee(); // Calls Cardiologist overridden method
        d4.consultationFee(); // Calls Surgeon overridden method
    }
}
